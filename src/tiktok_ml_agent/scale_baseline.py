...
def score_scale_validation_resumable(
    *,
    ...
    spec = BenchmarkSpec(
        ...
        profile_id="provisional-long-view-gauc-ndcg5-v1",
        label="long_view",
        metrics=("GAUC", "nDCG@5", "primary"),
        evaluator_path=str(evaluator_path),
        evaluator_sha256=identity["evaluator_sha256"],
        source_note="Interpretation - provisional starter evaluator applied to bonus artifact pending organizer contract.",
    )
