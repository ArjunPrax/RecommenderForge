...
| EXP-009 | Ensembles | Measured; R008 two-component, R010 three-component child EXP-009A is current validation leader. EXP-009B–D are predeclared, single-vector post-leader confirmations. |
