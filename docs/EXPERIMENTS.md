...
| EXP-017 | Resumable, identity-gated 27K scale validation and output | Robustness capability, not a metric change; interruption→resume equivalence and mismatch rejection measured in R024 |
