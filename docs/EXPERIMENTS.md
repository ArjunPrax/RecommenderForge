...
| EXP-009 | Ensembles | Measured; R008 two-component, R010 three-component child EXP-009A historical leader. EXP-009B–D were excluded from campaign use after a data-fingerprint mismatch; EXP-009E revalidated the frozen leader, and EXP-009F–H establish the converged campaign, confirmed in R035. |
